...
#ifndef ROSIDL_BUFFER_BACKEND_REGISTRY__BUFFER_BACKEND_LOADER_HPP_
#define ROSIDL_BUFFER_BACKEND_REGISTRY__BUFFER_BACKEND_LOADER_HPP_
...
#endif  // ROSIDL_BUFFER_BACKEND_REGISTRY__BUFFER_BACKEND_LOADER_HPP_
