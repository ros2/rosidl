...
macro(rosidl_generate_interfaces target)
  ...
  foreach(_tuple ${_non_idl_tuples})
    ...
    if(_extension STREQUAL ".srv")
      ...
      file(MAKE_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/rosidl_cmake_core/${_parent_folder}")
      set(_request_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_cmake_core/${_parent_folder}/${_name}_Request.msg")
      set(_response_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_cmake_core/${_parent_folder}/${_name}_Response.msg")
