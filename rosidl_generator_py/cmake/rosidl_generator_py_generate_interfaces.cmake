...
if(BUILD_TESTING)
  if(NOT "${_generated_msg_py_files}${_generated_msg_c_files}${_generated_msg_c_common_files} " STREQUAL " ")
    ...
    if(ament_cmake_cppcheck_FOUND)
      ...
      message(WARNING
        "'ament_cmake_cppcheck' not found. Interfaces generated by rosidl will "
        "not be tested. Please add the appropriate <test_depend> tag to this "
        "package's package.xml if you wish to test these files.")
    endif()
    ...
    if(ament_cmake_cpplint_FOUND)
      ...
      message(WARNING
        "'ament_cmake_cpplint' not found. Interfaces generated by rosidl will "
        "not be tested. Please add the appropriate <test_depend> tag to this "
        "package's package.xml if you wish to test these files.")
    endif()
    ...
    if(ament_cmake_pep8_FOUND)
      ...
      message(WARNING
        "'ament_cmake_pep8' not found. Interfaces generated by rosidl will "
        "not be tested. Please add the appropriate <test_depend> tag to this "
        "package's package.xml if you wish to test these files.")
    endif()
    ...
    if(ament_cmake_pep257_FOUND)
      ...
      message(WARNING
        "'ament_cmake_pep257' not found. Interfaces generated by rosidl will "
        "not be tested. Please add the appropriate <test_depend> tag to this "
        "package's package.xml if you wish to test these files.")
    endif()
    ...
    if(ament_cmake_pyflakes_FOUND)
      ...
      message(WARNING
        "'ament_cmake_pyflakes' not found. Interfaces generated by rosidl will "
        "not be tested. Please add the appropriate <test_depend> tag to this "
        "package's package.xml if you wish to test these files.")
    endif()
    ...
    if(ament_cmake_uncrustify_FOUND)
      ...
      message(WARNING
        "'ament_cmake_uncrustify' not found. Interfaces generated by rosidl will "
        "not be tested. Please add the appropriate <test_depend> tag to this "
        "package's package.xml if you wish to test these files.")
    endif()
  endif()
