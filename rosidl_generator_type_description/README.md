...
The SHA256 hashes generated by this package must match those generated by `rcl_calculate_type_hash`.
The `.json` files generated must, therefore, match the result of `rcl_type_description_to_hashable_json`.

## RIHS version selection

By default, type hashes use RIHS01 (SHA256). To use the shorter RIHS02 (BLAKE2s-128), pass `-DROSIDL_GENERATOR_USE_RIHS02=ON` to CMake when building your interface package.
This reduces the hash string length from 71 to 39 characters.
