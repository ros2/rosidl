...
from rosidl_parser.idl_to_message_spec import parse_idl_to_message_spec, parse_idl_to_service_spec

MESSAGE_IDL_PATH = pathlib.Path(__file__).parent / pathlib.Path('msg') / 'MyMessage.idl'
MESSAGE_ROSIDL_PATH = pathlib.Path(__file__).parent / pathlib.Path('msg') / 'MyMessage.msg'
...
def rosidl_msg_spec():
    return parse_idl_to_message_spec('tmp_msgs', MESSAGE_IDL_PATH)


def test_idl_to_rosidl_translation(rosidl_msg_spec):
    assert str(rosidl_msg_spec) == MESSAGE_ROSIDL_PATH.read_text()


# def test_message_parser_structure(message_rosidl_file):
...
# @pytest.fixture(scope='module')
# def service_rosidl_file():
#     return parse_idl_to_service_spec('tmp_msgs', SERVICE_IDL_PATH)


# def test_service_parser(service_rosidl_file):
