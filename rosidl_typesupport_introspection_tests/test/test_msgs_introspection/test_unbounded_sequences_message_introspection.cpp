...
using UnboundedSequencesMessageTypes = ::testing::Types<
  test_msgs__msg__UnboundedSequences, test_msgs::msg::UnboundedSequences>;
...
TYPED_TEST(UnboundedSequencesMessageIntrospectionTest, MessageDescriptorIsCorrect)
{
...

  {
    ...
    using basic_type =
      MEMBER_EXPRESSION_TYPE(UnboundedSequencesMessageT, basic_types_values[0]);
...

  {
    ...
    using constants_type =
      MEMBER_EXPRESSION_TYPE(UnboundedSequencesMessageT, constants_values[0]);
...

  {
    ...
    using defaults_type =
      MEMBER_EXPRESSION_TYPE(UnboundedSequencesMessageT, defaults_values[0]);
...
TYPED_TEST(UnboundedSequencesMessageIntrospectionTest, CanWriteTypeErasedMessage)
{
  ...
  ASSERT_SEQUENCE_MEMBER_ASSIGNMENT(
